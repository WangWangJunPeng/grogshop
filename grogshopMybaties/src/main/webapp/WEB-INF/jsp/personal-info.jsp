                    ...
                    <div class="col-lg-4">
                        ...
                        <form role="form" method="post">
                            ...
                            <div class="form-group" >
                                <label>昵称</label>
                                <input class="form-control" placeholder="请输入您的昵称" name="username">
                            </div>

                            <div class="form-group">
                                <label>邮箱</label>
                                <input class="form-control" placeholder="请输入您的邮箱" name="email">
                            </div>

                            <div class="form-group">
                                <label>电话</label>
                                <input class="form-control" placeholder="请输入您的电话" name="phone">
                            </div>
                            <button type="submit" class="btn btn-default" id="change">保存修改</button>
